...
Para mantener un historial consistente, los mensajes de commit de este repositorio seguirán estas 5 reglas:

1. Escribir siempre el mensaje en español.
...
- Turtle Crossing: corrige la detección de colisiones
- Quiz Game: agrega carga inicial de preguntas
- General: actualiza README y organización del repositorio
